...
Source: GizmoWeek | 2026-04-15

---

## What to Watch

- Claude Code Routines launched with scheduled, API-triggered, and GitHub-event-driven cloud automation, bringing agentic workflows to Anthropic's managed infrastructure and competing directly with Microsoft Copilot's always-on agent ambitions announced at Build 2026.
- BSCS-bench showed frontier models scoring 97% — a 3.92 GPA equivalent — on a full Rice University CS degree in under 13 hours for under $140, reigniting debate over whether CS education proxies remain meaningful in the age of AI code generation.
- The gap between AI's economic impact forecasts and worker-reported productivity gains remains stark: 40% of non-manager workers say AI saves them no time, while MIT research estimates 95% of firms are not yet seeing ROI on AI investments — a paradox driven by the emerging "workslop" problem, where AI automation costs an estimated $8.1 million per 10,000-person organization monthly in time spent correcting errors.
- Constitutional security frameworks — porting enterprise infrastructure primitives like capability tokens, Merkle integrity trees, and Byzantine fault tolerance directly into AI agent orchestration — represent an emerging engineering response to the six attack genres identified in Google DeepMind's taxonomy.
